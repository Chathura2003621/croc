const crocodileFacts = [
    ...
    {
        "fact": "They have a unique ability to see in the dark, thanks to a special membrane in their eyes."
    },
    {
...
document.getElementById('factButton').addEventListener('click', function() {
    ...
    const fact = crocodileFacts[randomIndex].fact;
    const factDisplay = document.getElementById('factDisplay');
    
    factDisplay.style.opacity = 0; // Fade out
    setTimeout(() => {
        factDisplay.textContent = fact; // Update fact
